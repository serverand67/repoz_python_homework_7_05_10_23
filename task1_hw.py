...
def group_rename_files(desired_name, digit_count, source_extension, target_extension, name_range):
    directory = os.getcwd() 
    file_counter = 1  
    ...
    for filename in os.listdir(directory):
        if filename.endswith(source_extension):
            ...
            file_number = str(file_counter).zfill(digit_count)
            
            new_name = original_name + file_number + target_extension
...
if __name__=="__main__":    
    group_rename_files("_new", 2, ".txt", ".jpg", [3, 6])